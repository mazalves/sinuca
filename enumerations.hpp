...
enum instruction_operation_t {
    ...
    /// MVX
    INSTRUCTION_OPERATION_MVX_LOCK,     //12
    INSTRUCTION_OPERATION_MVX_UNLOCK,   //13

    INSTRUCTION_OPERATION_MVX_LOAD,     //14
    INSTRUCTION_OPERATION_MVX_STORE,    //15

    INSTRUCTION_OPERATION_MVX_INT_ALU,  //16
    INSTRUCTION_OPERATION_MVX_INT_MUL,  //17
    INSTRUCTION_OPERATION_MVX_INT_DIV,  //18

    INSTRUCTION_OPERATION_MVX_FP_ALU,   //19
    INSTRUCTION_OPERATION_MVX_FP_MUL,   //20
    INSTRUCTION_OPERATION_MVX_FP_DIV    //21
};
...
enum memory_operation_t {
    ...
    MEMORY_OPERATION_MVX_INT_ALU,
    MEMORY_OPERATION_MVX_INT_MUL,
    MEMORY_OPERATION_MVX_INT_DIV,
