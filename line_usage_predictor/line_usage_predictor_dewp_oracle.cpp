...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_sub_blocks_to_package(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::predict_sub_blocks_to_package(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
bool line_usage_predictor_dewp_oracle_t::check_sub_block_is_hit(memory_package_t *package, uint64_t index, uint32_t way) {
...
/// ============================================================================
bool line_usage_predictor_dewp_oracle_t::check_line_is_last_access(uint32_t index, uint32_t way){
...
/// ============================================================================
bool line_usage_predictor_dewp_oracle_t::check_line_is_last_write(uint32_t index, uint32_t way){
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_hit(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_miss(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::sub_block_miss(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_send_writeback(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_recv_writeback(memory_package_t *package, uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_eviction(uint32_t index, uint32_t way) {
...
/// ============================================================================
void line_usage_predictor_dewp_oracle_t::line_invalidation(uint32_t index, uint32_t way) {
